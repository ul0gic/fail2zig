...
const action_outcome = @import("engine_test").core.native_action_outcome;
const action_context = @import("engine_test").core.native_action_context;
const lease_policy = @import("engine_test").core.native_lease;
const durable = @import("engine_test").core.record_store;
const canonical = @import("engine_test").firewall.scope;
const runtime = @import("engine_test").runtime.native_effect_runtime;
...
test "native effects: retry prolong commits state owner intent and stable history identity atomically" {
    ...
    const subject = @import("engine_test").core.native_detection_record.Subject{ .v4 = .{ 192, 0, 2, 51 } };

...
const t = std.testing;
const module = @import("engine_test").core.native_consumer_coordinator;
const rules = @import("engine_test").core.native_rules;
const rule = @import("engine_test").core.native_rule_consumer;
const ignores = @import("engine_test").core.native_ignore;
const dns = @import("engine_test").core.native_dns;
const detection = @import("engine_test").core.native_detection_record;
const state = @import("engine_test").core.native_consumer;
const gen = [_]u8{7} ** 32;
...
test "native coordinator: journal gate precedes custom context and forbids missing profile" {
    ...
    const profile = try @import("engine_test").core.native_journal_origin.Profile.init("0123456789abcdef0123456789abcdef", &.{"/usr/sbin/sshd"});

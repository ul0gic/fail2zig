...
const adapter = @import("engine_test").core.native_rule_consumer;
const definition =
...
;
const timing = @import("engine_test").core.native_correlation.Timing{ .occurrence = [_]u8{1} ** 32, .event_us = 10, .receipt_us = 11, .processing_us = 12 };
